...
export default function Homepage() {
  ...
  return (
    ...
    >
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <a href="#" className="flex items-center gap-0">
              ...
              <span className="hidden min-[420px]:inline text-base sm:text-lg font-bold tracking-tight transition-colors -ml-2" style={{ color: "var(--foreground)" }}>AutoFlow</span>
            </a>
      ...
      {/* Footer CTA */}
      <section className="py-16 md:py-24 transition-colors duration-300" style={{ background: "var(--background)" }}>
        <div className="container mx-auto px-4 max-w-3xl text-center">
          <h2 className="text-3xl md:text-5xl font-bold tracking-tight mb-4" style={{ color: "var(--foreground)" }}>Ready to automate?</h2>
      ...
      {/* Footer */}
      <footer className="border-t transition-colors duration-300" style={{ background: "var(--footer-bg)", borderColor: "var(--border-color)" }}>
        ...
        <div className="container mx-auto px-4 md:px-8 pb-7 pt-5 border-t" style={{ borderColor: "var(--border-color)" }}>
