  ...
  return (
    <div className="h-screen max-h-screen w-full flex flex-col lg:flex-row bg-[#F6F1EA] text-[#241812] selection:bg-[#EB5E3D]/20 selection:text-[#241812] overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-1/2 h-full bg-[#241812] text-[#F6F1EA] p-8 xl:p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="absolute -bottom-32 -right-32 w-96 h-96 rounded-full bg-[#DDA449]/15 blur-3xl pointer-events-none" />
        ...
        <div className="relative z-10 my-auto py-4 max-w-lg">
          ...
          <h1 className="text-3xl xl:text-4xl font-extrabold text-white tracking-tight leading-[1.15] mb-4">
            Automate your entire stack with visual AI pipelines.
          </h1>
          
          <p className="text-sm text-[#D5CDC5] leading-relaxed mb-6">
            Connect LLMs, databases, webhooks, and messaging tools in minutes. Pick up right where you left off.
          </p>
          ...
          <div className="bg-[#2E2019] rounded-2xl p-4 border border-white/10 shadow-lg">
            <div className="flex items-center justify-between mb-2.5 text-[11px] text-[#A89C94] font-mono">
              <span>ACTIVE FLOW: LEAD_TRIAGE</span>
              <span className="flex items-center gap-1 text-[#2EA38D] font-semibold">
                <span className="w-1.5 h-1.5 rounded-full bg-[#2EA38D] animate-pulse" />
                RUNNING
              </span>
            </div>
            <div className="flex items-center gap-2">
              <div className="flex-1 bg-[#3A2C24] rounded-xl p-2.5 border border-white/5 text-center">
                <p className="text-[9px] text-[#A89C94] uppercase font-bold">Trigger</p>
                <p className="text-[11px] font-bold text-white mt-0.5 truncate">POST /webhook</p>
              </div>
              <ArrowRightIcon className="w-3.5 h-3.5 text-[#EB5E3D] shrink-0" />
              <div className="flex-1 bg-[#3A2C24] rounded-xl p-2.5 border border-white/5 text-center">
                <p className="text-[9px] text-[#EB5E3D] uppercase font-bold">Claude 3.5</p>
                <p className="text-[11px] font-bold text-white mt-0.5 truncate">Summarize</p>
              </div>
              <ArrowRightIcon className="w-3.5 h-3.5 text-[#EB5E3D] shrink-0" />
              <div className="flex-1 bg-[#3A2C24] rounded-xl p-2.5 border border-white/5 text-center">
                <p className="text-[9px] text-[#5865F2] uppercase font-bold">Discord</p>
                <p className="text-[11px] font-bold text-white mt-0.5 truncate">#leads</p>
              </div>
            </div>
          </div>
        </div>
